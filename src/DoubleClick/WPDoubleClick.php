...
class WPDoubleClick {
    ...
    public static function run($wpdb) {
        ...
        if (is_admin()) {
            wp_enqueue_script('DoubleClickAdmin', plugins_url('../public/js/vendor/ControleOnline/admin.js', dirname(__FILE__)), null, null, true);
        ...
        wp_enqueue_script('DoubleClickAdmin', plugins_url('../public/js/vendor/ControleOnline/dfp.js', dirname(__FILE__)), null, null, true);
