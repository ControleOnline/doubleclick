...
# main config
PLUGINSLUG="double-click-plugin"
CURRENTDIR=`pwd`
MAINFILE="double-click-plugin.php" # this should be the name of your main php file in the wordpress plugin
...
SVNURL="http://plugins.svn.wordpress.org/double-click/" # Remote SVN repo on wordpress.org, with no trailing slash
